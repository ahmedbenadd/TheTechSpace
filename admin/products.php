    ...
    <main>
        ...
        <div id="page-content">
            <section class="table-container">
                <div class="title">
                    <h3>Products</h3>
                    <a href="productadd.php" class="add-btn">
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 8C11 7.44772 11.4477 7 12 7C12.5523 7 13 7.44771 13 8V11H16C16.5523 11 17 11.4477 17 12C17 12.5523 16.5523 13 16 13H13V16C13 16.5523 12.5523 17 12 17C11.4477 17 11 16.5523 11 16V13H8C7.44772 13 7 12.5523 7 12C7 11.4477 7.44771 11 8 11H11V8Z" fill="#ffffff"/>
                    ...
                    <table id="table">
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <div class="trash" data-productid="<?php echo $products['id']; ?>">
                                ...
                                <div class="edit">
                                    <a href=productedit.php?ytcd="<?php echo base64_encode('ppdv=' . $products['id']) ?>">
                                        ...
                                        <polygon fill="none" points="12.5 15.8 22 6.2 17.8 2 8.3 11.5 8 16 12.5 15.8" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/></g></g></g>
                                        </svg>
                                    </a>
                                </div>
                            </td>
