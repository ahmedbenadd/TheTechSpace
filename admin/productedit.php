<?php
    ...
    if (isset($_GET['ytcd'])) {
        $decoded_param = base64_decode($_GET['ytcd']);
        $product_id = substr($decoded_param, 5);
        ...
        <div id="page-content">
            <section id="form-container">
                ...
                <form autocomplete="off">
                    ...
                    <input type="text" id="name" class="product-input" value="<?php echo $row['name']; ?>">
                    <span id="name-error" class="error-message"></span>
                    <label for="Category" class="product-label">Category:</label>
                    <select id="category" class="product-input">
                        <option value="Laptops" <?php if($row['category'] == 'Laptops') echo 'selected'; ?>>Laptops</option>
                        <option value="Smartphones" <?php if($row['category'] == 'Smartphones') echo 'selected'; ?>>Smartphones</option>
                        <option value="Accessories" <?php if($row['category'] == 'Accessories') echo 'selected'; ?>>Accessories</option>
                        <option value="Components" <?php if($row['category'] == 'Components') echo 'selected'; ?>>Components</option>
                    </select>
                    <span id="category-error" class="error-message"></span>
                    <label for="description" class="product-label">Description:</label>
                    <textarea id="description" cols="30" rows="2" class="product-input" style="resize: none;"><?php echo $row['description']; ?></textarea>
                    <span id="description-error" class="error-message"></span>
                    <label for="longdescription" class="product-label">Long description:</label>
                    <textarea id="longdescription" cols="30" rows="5" class="product-input" style="resize: none;"><?php echo $row['long_description']; ?></textarea>
                    ...
                    <div class="smaller-input">
                        <div class="input-grp">
                            <div class="inner-input-grp">
                                ...
                                <input type="number" id="price" class="product-input" value="<?php echo $row['price']; ?>">
                                <span id="price-error" class="error-message"></span>
                            </div>
                            <div class="inner-input-grp">
                                <label for="quantity" class="product-label">Quantity:</label>
                                <input type="number" id="quantity" class="product-input" value="<?php echo $row['quantity']; ?>">
                        ...
                        <div class="input-grp">
                            <div class="inner-input-grp">
                                ...
                                <input type="text" id="img_1" class="product-input" value="<?php echo $row['img_1']; ?>">
                                <span id="img1-error" class="error-message"></span>
                            </div>
                            <div class="inner-input-grp">
                                <label for="img_2" class="product-label">Image 2:</label>
                                <input type="text" id="img_2" class="product-input" value="<?php echo $row['img_2']; ?>">
                        ...
                        <div class="input-grp">
                            <div class="inner-input-grp">
                                ...
                                <input type="text" id="img_3" class="product-input" value="<?php echo $row['img_3']; ?>">
                                <span id="img3-error" class="error-message"></span>
                            </div>
                            <div class="inner-input-grp">
                                <label for="img_4" class="product-label">Image 4:</label>
                                <input type="text" id="img_4" class="product-input" value="<?php echo $row['img_4']; ?>">
                    ...
                    <div class="btns">
                        <div class="inner-btns">
                            <button type="button" id="delete-btn" data-productid="<?php echo $row['id']; ?>">
                        ...
                        <a href="products.php"><span>&#8630;&nbsp; </span> All Products</a>
                    </div>        
                </form>
            </section>
        </div>
