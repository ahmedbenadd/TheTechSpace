                ...
                <div class="title">
                    ...
                    <table id="table">
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                <div class="trash" data-orderid="<?php echo $orders['order_id']; ?>">
                                ...
                                <div class="edit">
                                    <a href=orderedit.php?mttd="<?php echo base64_encode('cbdv=' . $orders['order_id']) ?>">
                            ...
                            <td class="table-chevron">
                                <a class="items-link" href=orderedit.php?mttd="<?php echo base64_encode('cbdv=' . $orders['order_id']) ?>">
                                    &#x3009;
                                </a>
                            </td>
                        </tr>
